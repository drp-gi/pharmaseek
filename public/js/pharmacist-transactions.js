document.addEventListener('DOMContentLoaded', () => {
  ...
  // Shows the selected medicine's picture beside its dropdown (native
  // <select> options can't render images themselves, so this mirrors the
  // choice in a small thumbnail next to the field instead).
  function wireMedicinePreview(selectId, imgId, iconId) {
    const select = document.getElementById(selectId);
  ...
  wireMedicinePreview('sale_medicine_id', 'saleMedicineThumbImg', 'saleMedicineThumbIcon');
  wireMedicinePreview('disposal_medicine_id', 'disposalMedicineThumbImg', 'disposalMedicineThumbIcon');
